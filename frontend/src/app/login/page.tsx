        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" className="w-full h-11" size="lg" disabled={isLoading}>
              {isLoading ? t("auth.status.pleaseWait") : (isLogin ? t("auth.login.submit") : t("auth.register.submit"))}
            </Button>
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center text-xs uppercase">
                <span className="bg-background px-2 text-muted-foreground">{t("auth.social.title")}</span>
              </div>
            </div>
            <Button
              type="button"
