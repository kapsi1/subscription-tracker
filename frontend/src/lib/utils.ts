 ...
 */
export function getCategoryColor(category: string, variant: 'default' | 'dashboard' = 'default'): string {
  ...
  const classes: Record<string, { default: string; dashboard: string }> = {
    purple: {
      default: "bg-purple-500/10 border-purple-500/20 dark:bg-purple-500/15 dark:border-purple-500/25",
      dashboard: "bg-purple-500/20 border-purple-500/25 dark:bg-purple-500/25 dark:border-purple-500/35",
    },
    blue: {
    ...
    green: {
      ...
      dashboard: "bg-green-500/20 border-green-500/25 dark:bg-green-500/25 dark:border-green-500/35",
    },
    orange: {
      default: "bg-orange-500/10 border-orange-500/20 dark:bg-orange-500/15 dark:border-orange-500/25",
      dashboard: "bg-orange-500/20 border-orange-500/25 dark:bg-orange-500/25 dark:border-orange-500/35",
    },
    rose: {
    ...
    amber: {
      ...
      dashboard: "bg-amber-500/20 border-amber-500/25 dark:bg-amber-500/25 dark:border-amber-500/35",
    },
    indigo: {
      default: "bg-indigo-500/10 border-indigo-500/20 dark:bg-indigo-500/15 dark:border-indigo-500/25",
      dashboard: "bg-indigo-500/20 border-indigo-500/25 dark:bg-indigo-500/25 dark:border-indigo-500/35",
    },
    teal: {
    ...
    yellow: {
      default: "bg-yellow-500/10 border-yellow-500/20 dark:bg-yellow-500/15 dark:border-yellow-500/25",
      dashboard: "bg-yellow-500/20 border-yellow-500/25 dark:bg-yellow-500/25 dark:border-yellow-500/35",
    },
    slate: {
      default: "bg-slate-500/10 border-slate-500/20 dark:bg-slate-500/15 dark:border-slate-500/25",
      dashboard: "bg-slate-500/20 border-slate-500/25 dark:bg-slate-500/25 dark:border-slate-500/35",
    },
  };
