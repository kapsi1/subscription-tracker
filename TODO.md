...
- [ ] Move the Install App button from the dropdown menu next to (to the left of) the right button on the nav bar. On mobile screens it should instead go on the same line as Dashboard title, but aligned to the right. It should have a "download" icon and Install App text.
